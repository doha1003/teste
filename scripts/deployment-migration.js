...
class DeploymentMigration {
  ...
  async preflightChecks() {
    ...
    const requiredFiles = ['css/main.css', 'js/main.js', 'vercel.json', 'manifest.json'];
  ...
  async createDirectories() {
    ...
    const directories = ['dist', 'dist/css', 'dist/js', 'dist/images', 'backup'];
  ...
  async updateHTML() {
    ...
    for (const file of htmlFiles) {
      try {
        ...
        content = content.replace(/{{BASE_URL}}/g, this.config.baseUrl);
