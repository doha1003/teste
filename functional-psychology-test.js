...
async function functionalTest() {
  ...
  const tests = [
    {
      ...
      actions: [
        {
          type: 'click',
          selector: '.teto-gender-btn[data-gender="female"]',
          description: '여성 선택',
        },
        { type: 'waitAndClick', selector: '.teto-start-button', description: '테스트 시작' },
        {
          type: 'waitForElement',
          selector: '.teto-question-container',
          description: '질문 화면 대기',
        },
      ],
    },
    {
      ...
      actions: [
        ...
        {
          type: 'waitForElement',
          selector: '.love-question-container',
          description: '질문 화면 대기',
        },
      ],
    },
    {
      ...
      actions: [
        ...
        {
          type: 'waitForElement',
          selector: '.mbti-question-container',
          description: '질문 화면 대기',
        },
      ],
    },
  ...
  console.log('\n' + '='.repeat(60));
  console.log(
    `📊 전체 결과: 완전성공 ${fullSuccess}개 / 부분성공 ${partialSuccess}개 / 실패 ${failed}개`
  );
