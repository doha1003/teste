...
class DohaLiveSiteVerifier {
  ...
  async testKeyFeatures() {
    ...
    try {
      ...
      // Check for questions
      const questionCount = await this.page.$$eval(
        '.question, .mbti-question, .question-item',
  ...
  async testMobileResponsiveness() {
    ...
    for (const url of testPages) {
      try {
        ...
        const touchElements = await this.page.$$eval(
          'button, .btn, a',
          (elements) =>
            elements.filter((el) => {
  ...
  async testPerformance() {
    ...
    for (const url of testPages) {
      try {
        ...
        const lazyImages = await this.page.$$eval(
