...
export const fortuneResponses = {
  daily: {
    success: true,
    fortune: '오늘은 새로운 기회가 찾아올 것입니다. 평소 미뤄두었던 일을 시작하기 좋은 날이며, 대인관계에서도 긍정적인 변화가 예상됩니다.',
    luckyColor: '파란색',
    luckyNumber: 7,
    luckyDirection: '동쪽',
  ...
  tarot: {
    ...
    interpretation: '당신의 여정은 순수한 시작에서 출발하여 현재 능력을 발휘하는 단계에 있으며, 궁극적으로는 큰 성취를 이룰 것입니다.',
