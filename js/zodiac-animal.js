...
// 띠별 운세 기본 데이터
const zodiacAnimals = {
    rat: { korean: '쥐띠', emoji: '🐀', element: '水', description: '지혜롭고 재빠른 쥐띠는 오늘 좋은 기회를 포착할 수 있습니다.' },
    ox: { korean: '소띠', emoji: '🐂', element: '土', description: '성실하고 근면한 소띠는 꾸준한 노력이 결실을 맺는 날입니다.' },
    tiger: { korean: '호랑이띠', emoji: '🐅', element: '木', description: '용맹하고 진취적인 호랑이띠는 도전 정신이 빛을 발하는 날입니다.' },
    rabbit: { korean: '토끼띠', emoji: '🐇', element: '木', description: '온화하고 신중한 토끼띠는 인간관계에서 좋은 소식이 있을 것입니다.' },
    dragon: { korean: '용띠', emoji: '🐉', element: '土', description: '위풍당당한 용띠는 리더십을 발휘하기 좋은 날입니다.' },
    snake: { korean: '뱀띠', emoji: '🐍', element: '火', description: '지혜롭고 신비로운 뱀띠는 직감을 믿고 행동하세요.' },
    horse: { korean: '말띠', emoji: '🐎', element: '火', description: '활동적이고 자유로운 말띠는 새로운 도전에 나서기 좋은 날입니다.' },
    sheep: { korean: '양띠', emoji: '🐑', element: '土', description: '온순하고 배려심 깊은 양띠는 주변 사람들과의 화합이 중요한 날입니다.' },
    monkey: { korean: '원숭이띠', emoji: '🐒', element: '金', description: '영리하고 재치 있는 원숭이띠는 창의적인 아이디어가 빛을 발할 것입니다.' },
    rooster: { korean: '닭띠', emoji: '🐓', element: '金', description: '부지런하고 정확한 닭띠는 계획한 일들이 순조롭게 진행될 것입니다.' },
    dog: { korean: '개띠', emoji: '🐕', element: '土', description: '충실하고 정의로운 개띠는 신뢰받는 하루가 될 것입니다.' },
    pig: { korean: '돼지띠', emoji: '🐖', element: '水', description: '관대하고 복이 많은 돼지띠는 예상치 못한 행운이 찾아올 것입니다.' }
};
