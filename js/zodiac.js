...
function generateDetailedZodiacMessage(zodiacSign, type) {
  const messages = {
    aries: {
      overall:
        '화성의 강력한 에너지가 당신의 행동력을 극대화시키는 날입니다. 오전 10시경부터 오후 2시까지가 가장 활발한 시간대이며, 이 시간에 중요한 회의나 프레젠테이션을 잡으면 좋은 결과를 얻을 수 있습니다. 다만 과도한 경쟁심으로 인해 주변 사람들과 마찰이 생길 수 있으니 한 템포 늦추는 여유가 필요합니다.',
