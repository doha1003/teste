...
class SajuCalculatorEnhanced {
    ...
    calculateSaju(year, month, day, hour, isLunar = false) {
        ...
        const dayPillar = lunarInfo && lunarInfo.dayGanji ? {
        ...
        // 십신 계산
        const tenGods = this.calculateTenGods(dayPillar.stem, yearPillar.stem, monthPillar.stem, hourPillar.stem);
    ...
    generateRelationshipAnalysis(saju) {
        ...
        let relationshipDesc = yinYang === '양' 
