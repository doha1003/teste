  ...
  constructor() {
    ...
    this.resultTypes = {
      SUPER_TETO: {
        ...
        description:
          "당신은 진짜 테토의 정수! 어디든 가면 분위기 메이커가 되고, 새로운 것에 대한 호기심이 넘치는 타입이에요. 친구들 사이에서도 '놀 때 꼭 불러야 하는 사람' 1순위죠!",
        traits: ['초사교적', '모험 추구', '트렌드 선도', '에너지 폭발', '리더십'],
        strengths:
          '어떤 상황에서도 분위기를 주도하고, 사람들에게 긍정 에너지를 전파합니다. 새로운 도전을 두려워하지 않아요.',
      ...
      MILD_TETO: {
        ...
        description:
          '테토의 기질은 있지만 상황을 보는 눈이 있는 타입이에요. 분위기 파악도 잘하고, 사람들과 어울리는 것도 좋아하지만 혼자 있는 시간도 즐길 줄 알아요.',
        traits: ['상황 적응력', '균형감', '소통 능력', '현실 감각', '배려심'],
        strengths:
          'TPO를 잘 파악하고, 다양한 사람들과 편하게 어울릴 수 있어요. 리더와 팔로워 역할 모두 가능합니다.',
      ...
      MILD_EGEN: {
        ...
        description:
          '사람들과 어울리는 걸 싫어하지는 않지만, 혼자만의 시간을 더 소중히 여기는 타입이에요. 깊이 있는 대화를 좋아하고, 진정한 친구 몇 명과의 관계를 중시해요.',
        traits: ['사려깊음', '진정성', '집중력', '안정 추구', '깊이'],
        strengths:
          '진심 어린 관계를 만들고, 신중한 판단력으로 실수를 줄입니다. 집중력이 뛰어나 깊이 있는 일을 잘해요.',
      ...
      SUPER_EGEN: {
        ...
        description:
          '진정한 에겐의 정수! 사람들과 어울리는 것보다 혼자 있을 때 가장 편안하고 행복해하는 타입이에요. 깊이 있는 취미나 관심사가 있고, 소수의 진짜 친구를 소중히 여겨요.',
        traits: ['극도 내향', '독립성', '창의성', '완벽주의', '심층 사고'],
        strengths:
          '혼자서도 충분히 행복하고, 창의적이고 독창적인 아이디어를 만들어냅니다. 집중력이 뛰어나요.',
        growth:
          '가끔은 사람들과의 소통도 시도해보세요. 당신의 깊은 생각을 다른 사람들과 나누면 더 큰 의미가 있을 거예요.',
