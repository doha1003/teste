  ...
  constructor() {
    ...
    this.mbtiTypes = {
      INTJ: {
        ...
        description:
          '상상력이 풍부하고 전략적인 사고를 하는 완벽주의자입니다. 복잡한 문제를 해결하는 것을 즐기며, 높은 기준을 가지고 있습니다.',
        strengths:
          '독립적이고 결단력 있으며, 전략적 사고에 뛰어납니다. 복잡한 문제를 해결하는 능력이 탁월합니다.',
        weaknesses:
          '지나치게 비판적일 수 있으며, 감정 표현에 서툴 수 있습니다. 완벽주의 성향이 스트레스를 유발할 수 있습니다.',
        growth:
          '타인의 감정을 이해하고 공감하는 능력을 키우세요. 완벽하지 않아도 괜찮다는 것을 받아들이는 연습이 필요합니다.',
      ...
      INTP: {
        ...
        description:
          '혁신적이고 독창적인 아이디어를 추구하는 사색가입니다. 논리적 사고를 중시하며, 지적 호기심이 강합니다.',
        strengths: '분석력이 뛰어나고 객관적입니다. 창의적이고 독창적인 해결책을 제시합니다.',
        weaknesses:
          '감정 표현이 서툴고 사회적 상황에서 어색할 수 있습니다. 실용적인 측면을 간과할 수 있습니다.',
      ...
      ENTJ: {
        ...
        description:
          '대담하고 상상력이 풍부한 강력한 의지의 지도자입니다. 목표 달성을 위해 효율적으로 일하며, 리더십이 뛰어납니다.',
      ...
      ENTP: {
        ...
        description:
          '지적 도전을 즐기는 영리하고 호기심이 많은 사상가입니다. 새로운 아이디어를 탐구하고 토론하는 것을 좋아합니다.',
      ...
      INFJ: {
        ...
        description:
          '선의의 옹호자이며 창의적이고 통찰력 있는 이상주의자입니다. 타인을 돕는 것에 열정적이며, 강한 가치관을 가지고 있습니다.',
      ...
      INFP: {
        ...
        description:
          '열정적이고 창의적인 자유로운 영혼의 중재자입니다. 강한 가치관을 가지고 있으며, 진정성을 중요시합니다.',
      ...
      ENFJ: {
        ...
        description:
          '카리스마 있고 영감을 주는 타고난 지도자입니다. 타인의 성장을 돕는 것에 열정적이며, 강한 리더십을 발휘합니다.',
      ...
      ENFP: {
        ...
        description:
          '열정적이고 창의적인 사회적 자유 정신입니다. 새로운 가능성을 탐구하고, 타인과의 연결을 중요시합니다.',
      ...
      ISTJ: {
        ...
        description:
          '사실적이고 신뢰할 수 있는 실용적인 현실주의자입니다. 책임감이 강하고, 전통과 질서를 중요시합니다.',
      ...
      ISFJ: {
        ...
        description:
          '따뜻하고 배려심 많은 항상 타인을 도울 준비가 된 수호자입니다. 안정성을 중시하며, 타인의 필요에 민감합니다.',
      ...
      ESTJ: {
        ...
        description:
          '뛰어난 관리 능력을 가진 의지가 강하고 헌신적인 경영자입니다. 조직과 질서를 중시하며, 목표 달성에 집중합니다.',
      ...
      ESFJ: {
        ...
        description:
          '배려심이 많고 사교적이며 항상 도움을 주려는 집정관입니다. 조화를 중시하며, 타인의 행복을 추구합니다.',
      ...
      ISTP: {
        ...
        description:
          '대담하고 실용적인 실험 정신이 강한 만능재주꾼입니다. 도구를 다루는데 능숙하며, 문제 해결을 즐깁니다.',
      ...
      ISFP: {
        ...
        description:
          '유연하고 매력적인 항상 새로운 가능성을 탐색하는 예술가입니다. 자유를 사랑하며, 자신만의 가치관을 중요시합니다.',
      ...
      ESTP: {
        ...
        description:
          '영리하고 에너지가 넘치며 인식이 뛰어난 사업가입니다. 현재에 집중하며, 실용적인 해결책을 찾습니다.',
      ...
      ESFP: {
        ...
        description:
          '자발적이고 열정적이며 사교적인 자유로운 영혼입니다. 삶을 즐기며, 타인과 함께하는 것을 좋아합니다.',
