...
export class LoveDNATestService extends TestService {
        ...
        getDetailedDescription(result) {
            const descriptions = {
                ADVENTUROUS_LOVER: '당신은 연애에서도 새로운 경험과 도전을 즐기는 타입입니다. 매일 같은 일상보다는 특별한 이벤트와 서프라이즈를 좋아하며, 연인과 함께 성장하고 발전하는 관계를 추구합니다.',
                ROMANTIC_DREAMER: '당신은 연인과의 깊은 정서적 유대를 중요시하며, 낭만적인 사랑을 꿈꾸는 이상주의자입니다. 영화나 소설 같은 아름다운 사랑 이야기를 현실에서 만들고 싶어합니다.',
                STEADY_COMPANION: '당신은 연애에서 신뢰와 안정감을 가장 중요하게 생각합니다. 화려한 이벤트보다는 일상 속에서 함께하는 소소한 행복을 소중히 여기며, 장기적인 관계를 지향합니다.',
                CARING_SUPPORTER: '당신은 연인의 행복을 자신의 행복으로 여기는 헌신적인 타입입니다. 상대방의 필요를 먼저 살피고, 조건 없는 사랑을 베풀며, 연인이 성장할 수 있도록 뒤에서 든든히 지원합니다.'
            };
        ...
        getStrengths(result) {
            const strengths = {
                ADVENTUROUS_LOVER: '열정적인 에너지, 창의적인 데이트 아이디어, 도전정신, 유머감각, 적극적인 애정표현',
                ROMANTIC_DREAMER: '깊은 공감 능력, 낭만적 감성, 진심 어린 사랑, 예술적 감성, 연인에 대한 헌신',
        ...
        getDatingStyle(result) {
            const styles = {
                ADVENTUROUS_LOVER: '액티비티 데이트를 선호하며, 새로운 장소와 경험을 함께 탐험합니다. 연인과 함께 모험을 즐기며 잊지 못할 추억을 만들어가는 것을 좋아합니다.',
                ROMANTIC_DREAMER: '낭만적이고 감성적인 데이트를 선호합니다. 예상치 못한 깜짝 이벤트나 특별한 장소에서의 데이트를 통해 연인과의 특별한 추억을 만들어가는 것을 좋아합니다.',
                STEADY_COMPANION: '편안하고 안정적인 데이트를 선호합니다. 좋아하는 카페에서 대화를 나누거나, 집에서 함께 요리하며 일상을 공유하는 것에서 행복을 느낍니다.',
                CARING_SUPPORTER: '연인이 좋아하는 활동 위주로 데이트를 계획합니다. 상대방이 편안하고 행복해하는 모습을 보는 것이 가장 큰 기쁨이며, 작은 배려로 사랑을 표현합니다.'
            };
        ...
        getGrowthPoint(result) {
            const growth = {
                ADVENTUROUS_LOVER: '일상의 소중함을 깨닫고, 안정적인 관계 유지를 위한 노력이 필요합니다. 때로는 조용한 시간도 함께 즐기는 법을 배워보세요.',
                ROMANTIC_DREAMER: '현실적인 관계 목표를 설정하고 작은 일상에서도 행복을 찾는 연습이 필요합니다. 완벽하지 않아도 충분히 아름다운 사랑임을 인정하세요.',
                STEADY_COMPANION: '가끔은 일상을 벗어난 특별한 이벤트로 관계에 활력을 불어넣어보세요. 새로운 시도가 관계를 더욱 깊게 만들 수 있습니다.',
                CARING_SUPPORTER: '자신의 욕구와 필요도 중요하다는 것을 인식하고 표현하는 연습이 필요합니다. 건강한 관계는 서로가 함께 성장하는 것입니다.'
            };
        ...
        getCompatibilityData(result) {
            ...
            return compatibility[result.resultKey] || {
                best: ['모든 유형과 조화 가능'],
                good: ['이해심 많은 타입'],
                challenge: ['극단적인 성향']
            };
