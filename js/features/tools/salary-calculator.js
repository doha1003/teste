...
(function() {
    ...
    class SalaryCalculatorService extends ToolService {
        constructor() {
            super({
        ...
        displayResult(result, originalSalary) {
            ...
            this.updateElement(this.ui.employmentInsurance, this.formatCurrency(result.employmentInsurance));
    ...
    // 전역 인스턴스 생성
    window.salaryCalculatorService = new SalaryCalculatorService();
