...
class KoreanOptimizer {
  constructor() {
    ...
    this.config = {
      ...
      fonts: {
        ...
        fallback: ['Pretendard', '-apple-system', 'BlinkMacSystemFont', 'system-ui', 'Roboto', 'Helvetica Neue', 'Segoe UI', 'Apple SD Gothic Neo', 'Noto Sans KR', 'Malgun Gothic', 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol', 'sans-serif'],
  ...
  // 한글 검색 처리
  handleKoreanSearch(query, input) {
  ...
  collectKoreanMetrics() {
    const metrics = {
      ...
      fontLoadingTime: performance.getEntriesByType('resource')
