...
const tetoEgenTypes = {
  teto_male: {
    ...
    description:
      '당신은 자유롭고 창의적인 성격으로 변화를 즐기는 테토형 남성입니다. 즉흥적이고 감정 표현이 풍부하며, 새로운 경험을 추구하는 모험정신을 가지고 있습니다.',
    percentage: '23%',
    traits: [
      '자유로운 사고와 행동',
      '창의적이고 독창적',
    ...
    growth:
      '목표 설정과 단계적 계획 수립을 통해 창의성을 구체적인 결과로 연결하는 연습이 필요합니다.',
    bestMatches: ['차분한 에겐녀'],
  ...
  teto_female: {
    ...
    description:
      '당신은 감성적이고 예술적인 테토형 여성입니다. 자유로운 영혼을 가지고 있으며, 감정이 풍부하고 창의적인 표현을 좋아합니다.',
    percentage: '22%',
    traits: [
      '감성적이고 예술적',
      '자유로운 표현',
  ...
  egen_male: {
    ...
    description:
      '당신은 차분하고 신중한 에겐형 남성입니다. 계획적이고 현실적인 판단을 하며, 책임감이 강하고 안정성을 추구합니다.',
    percentage: '28%',
    traits: [
      '계획적이고 체계적',
      '신중하고 현실적인 판단',
    ...
    strengths:
      '뛰어난 분석력과 계획성으로 안정적인 결과를 만들어내고 주변 사람들에게 신뢰감을 줍니다.',
  ...
  egen_female: {
    ...
    description:
      '당신은 현명하고 따뜻한 에겐형 여성입니다. 배려심이 깊고 안정적이며, 주변 사람들을 잘 챙기는 성숙한 성격을 가지고 있습니다.',
    percentage: '27%',
    traits: [
      '따뜻하고 배려심이 깊음',
      '현명하고 성숙한 판단',
    ...
    growth:
      '자신의 needs도 중요하게 여기고, 때로는 spontaneous한 면을 발휘하는 것이 도움이 됩니다.',
...
function showQuestion() {
  ...
  document.getElementById('progress-text').textContent =
    `질문 ${currentQuestion + 1} / ${tetoEgenQuestions.length}`;
  ...
  document.getElementById('next-btn').textContent =
    currentQuestion === tetoEgenQuestions.length - 1 ? '결과 보기' : '다음';
...
function showResult() {
  ...
  document.getElementById('result-rarity').textContent = `비율: ${currentTypeData.percentage}`;
