...
const mbtiTypes = {
  INTJ: {
    ...
    nickname: '전략적 완벽주의자',
    description:
      '독립적이고 혁신적인 사고를 가진 전략가입니다. 복잡한 문제를 해결하고 시스템을 개선하는 것을 좋아하며, 자신만의 비전을 실현하기 위해 노력합니다.',
    rarity: 'RARE',
    percentage: '2.1%',
    ...
    weaknesses:
      '지나친 완벽주의로 스트레스를 받기 쉽고, 감정 표현이나 팀워크에 어려움을 겪을 수 있습니다.',
    growth:
      '다른 사람의 감정에 대한 이해를 높이고, 완벽함보다는 실행에 집중하는 연습이 필요합니다.',
  ...
  INFP: {
    ...
    nickname: '이상주의적 몽상가',
    description:
      '깊은 가치관을 가지고 있으며 진정성을 추구하는 이상주의자입니다. 창의적이고 개방적이며, 타인을 이해하고 도우려는 마음이 큽니다.',
    rarity: 'UNCOMMON',
    percentage: '4.4%',
  ...
  ENFP: {
    ...
    nickname: '열정적 영감자',
    description:
      '열정적이고 창의적인 자유영혼입니다. 사람들과의 깊은 관계를 중시하며, 새로운 가능성을 탐구하고 다른 사람들에게 영감을 주는 것을 좋아합니다.',
    rarity: 'COMMON',
    percentage: '8.1%',
    ...
    weaknesses:
      '집중력 부족과 일관성 부족으로 프로젝트를 끝까지 완수하는데 어려움을 겪을 수 있습니다.',
...
const defaultMbtiType = {
  ...
  nickname: '특별한 개성',
  description:
    '당신만의 독특한 성격을 가지고 있습니다. 기존의 틀에 얽매이지 않고 자신만의 방식으로 세상을 바라봅니다.',
  rarity: 'UNIQUE',
  percentage: '특별함',
...
function showQuestion() {
  ...
  document.getElementById('next-btn').textContent =
    currentQuestion === mbtiQuestions.length - 1 ? '결과 보기' : '다음';
...
function showResult() {
  ...
  document.getElementById('result-rarity').textContent =
    `희귀도: ${typeData.rarity} (${typeData.percentage})`;
