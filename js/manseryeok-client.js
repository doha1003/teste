            ...
            try {
                ...
                for (const date of uncachedDates) {
                    try {
                        ...
                        console.error(`Failed to get date ${date.year}-${date.month}-${date.day}:`, err);
                    }
                }
            }
        }
...
window.getManseryeokDataAsync = async function(year, month, day) {
    try {
        ...
        console.error('Failed to get manseryeok data:', error);
        return null;
    }
};
...
window.getManseryeokData = function(year, month, day) {
    console.warn('getManseryeokData is deprecated. Use getManseryeokDataAsync instead.');
