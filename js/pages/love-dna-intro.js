...
(function () {
  ...
  class LoveDnaIntroPage {
    ...
    getButtonSection(button) {
      ...
      if (section) {
        if (section.classList.contains('hero') || section.classList.contains('love-hero')) {
          return 'hero';
        }
        if (section.classList.contains('cta') || section.classList.contains('love-cta-section')) {
          return 'cta';
        }
      }
      return 'unknown';
