...
(function() {
    ...
    class TermsPage {
        ...
        smoothScrollTo(target) {
            ...
            const targetPosition = target.getBoundingClientRect().top + window.pageYOffset - this.config.smoothScroll.offset;
            const distance = targetPosition - startPosition;
            const duration = this.config.smoothScroll.duration;
            let start = null;
         ...
         */
        initSectionObserver() {
            const sections = document.querySelectorAll('.terms-section[data-section]');
