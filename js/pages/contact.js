  ...
  class ContactPage {
    ...
    initSectionObserver() {
      const sections = document.querySelectorAll(
        '.contact-section[data-section], .faq-section[data-section]'
      );
    ...
    updateCharCounter(field) {
      ...
      if (!counter) {
        ...
        counter.style.cssText =
          'font-size: 0.75rem; color: #666; float: right; margin-top: 0.25rem;';
        field.parentElement.appendChild(counter);
      }

      const { max } = this.config.validation.message;
