...
const loveDNATypes = {
  ...
  TFALD: {
    ...
    description:
      '외모와 센스를 중요시하면서도 자유로운 관계를 추구하는 당신은 스킨십으로 애정을 표현하고, 관계에서 주도권을 잡는 것을 선호합니다. 직설적이고 솔직한 소통으로 건강한 연애를 만들어갑니다.',
    strengths: [
      '뛰어난 심미안',
      '자신감과 매력',
      '솔직한 소통',
    ...
    datingStyle:
      '트렌디한 장소에서의 세련된 데이트를 즐기며, 자연스러운 스킨십을 통해 친밀감을 표현합니다.',
    growth:
      '외모뿐만 아니라 내면의 아름다움도 인정하고, 상대방의 의견에 더 귀 기울이는 연습이 필요합니다.',
    rarity: '희귀 (12%)',
  ...
  WCPFC: {
    ...
    description:
      '진심 어린 대화를 통해 사랑을 표현하고, 연인과 가까운 관계를 원합니다. 상대방의 인품을 가장 중요하게 여기며, 관계에서는 지지하는 역할을 하면서도 타협을 통해 조화로운 관계를 만들어갑니다.',
    strengths: [
      '깊은 공감 능력',
      '진실한 소통',
      '헌신적인 사랑',
    ...
    datingStyle:
      '조용하고 아늑한 곳에서 깊은 대화를 나누며, 진심 어린 편지나 메시지로 사랑을 표현합니다.',
    growth:
      '적당한 개인 공간을 인정하고, 자신의 의견을 더 당당하게 표현하는 것이 필요합니다.',
    rarity: '흔함 (28%)',
  ...
  GMIFI: {
    ...
    description:
      '선물을 통해 마음을 표현하고, 연인의 지적 능력을 높이 평가합니다. 적당한 독립성을 유지하면서도 상황에 따라 유연하게 대처하며, 갈등을 피하면서도 문제를 해결하는 지혜로운 연인입니다.',
    strengths: [
      '센스있는 표현',
      '지적 호기심',
      '유연한 사고',
    ...
    datingStyle:
      '의미있는 선물을 주고받으며, 박물관이나 전시회 같은 지적 자극이 있는 데이트를 선호합니다.',
    growth:
      '더 직접적이고 솔직한 감정 표현과 갈등에 대한 적극적인 해결 의지가 필요합니다.',
    rarity: '보통 (22%)',
  ...
  TCSLD: {
    ...
    description:
      '함께하는 시간을 가장 중요하게 여기고, 연인에게 강한 애착을 보입니다. 상대방의 사회적 지위와 성공을 중요시하며, 관계에서 주도적 역할을 하면서 직접적인 소통을 선호합니다.',
    strengths: [
      '강한 사랑',
      '보호 본능',
      '리더십',
    ...
    datingStyle:
      '가능한 많은 시간을 함께 보내려 하고, 고급 레스토랑이나 특별한 장소에서의 데이트를 선호합니다.',
    growth:
      '상대방의 개인 공간을 존중하고, 외적 조건보다 내면의 가치에도 관심을 가져야 합니다.',
    rarity: '드물음 (8%)',
  ...
  WFPFA: {
    ...
    description:
      '진실한 대화를 통해 마음을 나누며, 자유로운 관계를 추구합니다. 상대방의 인품과 성격을 가장 중요하게 여기고, 상황에 맞게 유연하게 대처하며, 모든 것을 포용하는 넓은 마음을 가지고 있습니다.',
    ...
    datingStyle:
      '자연스러운 대화가 있는 카페나 산책 등 편안한 데이트를 선호하며, 서로의 생각과 철학을 나눕니다.',
  ...
  TMAIC: {
    ...
    description:
      '자연스러운 스킨십을 좋아하지만 적당한 거리를 유지하며, 외모와 스타일을 중시합니다. 독립적인 관계를 추구하면서도 필요할 때는 타협하는 성숙한 연애관을 가지고 있습니다.',
    ...
    datingStyle:
      '센스있고 아름다운 장소에서의 데이트를 좋아하며, 서로의 독립성을 존중하는 관계를 선호합니다.',
  ...
  GCSFI: {
    ...
    description:
      '선물과 물질적 표현을 통해 사랑을 보여주며, 연인에게 강하게 애착하는 스타일입니다. 상대방의 성공과 지위를 중요시하고, 지지하는 역할을 선호하며, 직접적인 갈등보다는 우회적인 방식을 택합니다.',
    strengths: [
      '헌신적인 사랑',
      '물질적 지원',
      '충성심',
    ...
    datingStyle:
      '고급스럽고 특별한 장소에서 데이트하며, 값비싼 선물과 이벤트로 사랑을 표현합니다.',
  ...
  WMILD: {
    ...
    description:
      '진심 어린 대화를 통해 소통하고, 적절한 거리를 유지하며, 지적인 매력을 중요시합니다. 관계에서 이끄는 역할을 하면서도 솔직하고 직접적인 소통으로 건강한 관계를 만들어갑니다.',
    strengths: [
      '지적 매력',
      '리더십',
      '균형감',
    ...
    datingStyle:
      '지적 대화가 있는 북카페나 문화 공간에서의 데이트를 선호하며, 서로 성장할 수 있는 관계를 추구합니다.',
