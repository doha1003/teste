...
const expandedZodiacData = {
  aries: {
    ...
    personality: {
      ...
      traits:
        '천성적인 리더로 새로운 것을 시작하는 것을 좋아합니다. 열정적이고 에너지가 넘치며, 도전을 즐깁니다.',
      koreanTraits:
        '번개탄처럼 빠른 실행력과 뜨거운 열정을 가진 행동파입니다. 한국 사회에서는 창업가나 스포츠 선수로 성공하는 경우가 많습니다.',
    },
    career: {
      suitable: [
        'CEO/창업가',
      ...
      strengths:
        '새로운 프로젝트를 시작하는 능력이 뛰어나고, 경쟁 상황에서 최고의 성과를 발휘합니다.',
      advice:
        '너무 성급하게 결정하지 말고, 팀워크를 중시하는 태도가 필요합니다.',
    },
    love: {
      style:
        '열정적이고 직진적인 연애를 합니다. 첫눈에 반해 적극적으로 어프로치하는 타입입니다.',
      preference: '자신과 비슷하게 활동적이고 독립적인 상대를 선호합니다.',
      koreanDating:
        '썸보다는 확실한 고백을 선호하고, 밀당보다는 직진을 좋아합니다. 데이트도 액티비티 중심으로 즐깁니다.',
      compatibility: {
        best: ['사자자리', '사수자리'],
        good: ['쌍둥이자리', '물병자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국 음식 중에서는 매운 음식을 좋아하지만 위장에 무리가 될 수 있으니 적당히 드세요.',
    },
    money: {
      tendency:
        '충동적인 소비를 하는 경향이 있지만, 돈 버는 능력도 뛰어납니다.',
      investment:
        '주식이나 창업 등 적극적인 투자를 선호하지만 위험 관리가 필요합니다.',
      koreanMoney:
        '한국에서는 부동산보다는 주식이나 코인 같은 변동성 높은 투자를 선호하는 경향이 있습니다.',
    },
  },
  ...
  taurus: {
    ...
    personality: {
      ...
      traits:
        '안정을 추구하고 꾸준히 노력하는 성격입니다. 예술적 감각이 뛰어나고 미적 센스가 좋습니다.',
      koreanTraits:
        '한국의 전통적인 미덕인 성실함과 끈기를 잘 보여주는 별자리입니다. 장인 정신이 뛰어나 전문 분야에서 성공합니다.',
    },
    career: {
      suitable: [
        '요리사',
    ...
    love: {
      style:
        '안정적이고 장기적인 관계를 추구합니다. 서두르지 않고 천천히 사랑을 키워나갑니다.',
      preference: '경제적으로 안정되고 가정적인 상대를 선호합니다.',
      koreanDating:
        '결혼 전제의 진지한 만남을 선호하고, 부모님께 인사드리는 것을 중요하게 생각합니다.',
      compatibility: {
        best: ['처녀자리', '염소자리'],
        good: ['게자리', '물고기자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국 전통 음식인 된장, 청국장 등 발효 음식이 건강에 특히 좋습니다.',
    },
    money: {
      tendency: '저축을 잘하고 안전한 투자를 선호합니다.',
      investment: '부동산, 금, 정기예금 등 안정적인 자산에 투자합니다.',
      koreanMoney:
        '한국에서는 아파트 투자나 전세 등 부동산 관련 투자에서 좋은 성과를 냅니다.',
    },
  },
  ...
  gemini: {
    ...
    personality: {
      ...
      traits:
        '호기심이 많고 새로운 정보를 빠르게 습득합니다. 뛰어난 소통 능력으로 사람들과 쉽게 어울립니다.',
      koreanTraits:
        'SNS와 인터넷 문화에 빠르게 적응하며, 한국의 빠른 트렌드 변화를 가장 잘 따라잡는 별자리입니다.',
    },
    career: {
      suitable: [
        '기자',
    ...
    love: {
      style:
        '지적인 대화를 통해 사랑을 표현하고, 다양한 사람과 만나기를 좋아합니다.',
      preference: '똑똑하고 유머가 있으며 대화가 통하는 상대를 선호합니다.',
      koreanDating:
        '카톡이나 SNS로 소통하는 것을 좋아하고, 다양한 데이트 코스를 시도합니다.',
      compatibility: {
        best: ['천칭자리', '물병자리'],
        good: ['양자리', '사자자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국의 바쁜 생활 패턴에 잘 적응하지만 번아웃 주의가 필요합니다.',
    },
    money: {
      tendency:
        '다양한 수입원을 만들려고 하지만 집중력 부족으로 중도에 포기할 수 있습니다.',
      investment:
        '새로운 투자 상품에 관심이 많지만 충분한 공부 후 투자해야 합니다.',
      koreanMoney:
        '한국에서는 IT 관련 주식이나 새로운 핀테크 서비스 투자에 관심이 많습니다.',
    },
  },
  ...
  cancer: {
    ...
    personality: {
      ...
      traits:
        '가족과 집을 중요하게 여기며, 타인을 돌보는 것을 좋아합니다. 감수성이 풍부하고 직감이 뛰어납니다.',
      koreanTraits:
        '한국의 강한 가족 문화와 잘 맞으며, 효도와 가족 화목을 가장 중시합니다. 정(情) 문화의 대표 주자입니다.',
    },
    career: {
      suitable: [
        '간호사',
      ...
      strengths:
        '타인을 돌보고 보살피는 능력이 뛰어나며, 안정적인 환경에서 최고의 성과를 발휘합니다.',
      advice: '감정에 휩쓸리지 않고 객관적인 판단력을 기르는 것이 필요합니다.',
    },
    love: {
      style: '깊고 진실한 사랑을 추구하며, 상대방을 보살피고 지켜주려 합니다.',
      preference:
        '가정적이고 안정적인 상대를 선호하며, 결혼과 출산을 중요하게 생각합니다.',
      koreanDating:
        '부모님 허락을 중요시하고, 명절에 함께 보내는 것을 당연하게 생각합니다.',
      compatibility: {
        best: ['전갈자리', '물고기자리'],
        good: ['황소자리', '처녀자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국 전통 보양식인 삼계탕, 미역국 등이 건강에 특히 좋습니다.',
    },
    money: {
      tendency:
        '미래를 대비해 꾸준히 저축하며, 가족을 위한 지출을 아끼지 않습니다.',
      investment: '안전한 투자를 선호하며, 부동산이나 보험에 관심이 많습니다.',
      koreanMoney:
        '한국에서는 자녀 교육비나 부모님 효도비에 많은 투자를 합니다.',
    },
  },
  ...
  leo: {
    ...
    personality: {
      ...
      traits:
        '타고난 리더로 주목받는 것을 좋아하며, 창의적이고 열정적입니다. 관대하고 따뜻한 마음을 가지고 있습니다.',
      koreanTraits:
        '한국 연예계나 방송계에서 많이 볼 수 있는 스타형 별자리입니다. 화려한 것을 좋아하고 브랜드를 중시합니다.',
    },
    career: {
      suitable: ['배우', '가수', '모델', '디자이너', '광고업', 'CEO', '정치가'],
      strengths: '무대에서 빛나며, 창의적인 아이디어로 사람들을 이끌어갑니다.',
      advice:
        '다른 사람들의 의견도 존중하고 팀워크를 중시하는 자세가 필요합니다.',
    },
    love: {
      style:
        '드라마틱하고 로맨틱한 연애를 즐기며, 상대방을 공주/왕자처럼 대합니다.',
      preference: '자신을 인정해주고 칭찬해주는 상대를 선호합니다.',
      koreanDating:
        '인스타그램에 올릴 만한 예쁜 데이트를 좋아하고, 기념일을 중요하게 생각합니다.',
      compatibility: {
        best: ['양자리', '사수자리'],
        good: ['쌍둥이자리', '천칭자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국 음식 중 기름진 음식을 좋아하지만 심혈관 건강을 위해 절제가 필요합니다.',
    },
    money: {
      tendency:
        '돈을 화려하게 쓰는 것을 좋아하며, 브랜드 제품이나 명품에 투자합니다.',
      investment:
        '눈에 띄는 투자를 선호하며, 주식보다는 부동산이나 예술품에 관심이 많습니다.',
      koreanMoney:
        '한국에서는 강남 부동산이나 명품, 고급차에 투자하는 경향이 있습니다.',
    },
  },
  ...
  virgo: {
    ...
    personality: {
      ...
      traits:
        '세심하고 분석적이며, 모든 일을 완벽하게 처리하려 합니다. 실용적이고 도움이 되는 일을 좋아합니다.',
      koreanTraits:
        '한국의 교육열과 완벽주의 문화에 잘 맞으며, 공무원이나 전문직에서 많이 성공합니다.',
    },
    career: {
      suitable: [
        '의사',
      ...
      strengths:
        '꼼꼼하고 정확한 업무 처리 능력이 뛰어나며, 문제 해결 능력이 탁월합니다.',
      advice: '너무 완벽을 추구하지 말고 적당한 선에서 타협하는 법을 배우세요.',
    },
    love: {
      style:
        '신중하고 조심스러운 연애를 하며, 상대방의 작은 부분까지 세심하게 챙깁니다.',
      preference:
        '성실하고 안정적인 상대를 선호하며, 외모보다는 내실을 중시합니다.',
      koreanDating:
        '상대방의 학력, 직업, 가정환경 등을 꼼꼼히 따져보고 신중하게 연애합니다.',
      compatibility: {
        best: ['황소자리', '염소자리'],
        good: ['게자리', '전갈자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국의 건강식품이나 유기농 음식에 관심이 많고, 정기 검진을 빼먹지 않습니다.',
    },
    money: {
      tendency:
        '계획적이고 체계적으로 돈을 관리하며, 가계부를 꼼꼼히 작성합니다.',
      investment:
        '안전하고 확실한 투자를 선호하며, 충분한 정보 수집 후 결정합니다.',
      koreanMoney:
        '한국에서는 적금이나 펀드 등 안정적인 금융상품을 선호합니다.',
    },
  },
  ...
  libra: {
    ...
    personality: {
      ...
      traits:
        '균형과 조화를 중시하며, 뛰어난 미적 감각을 가지고 있습니다. 평화를 사랑하고 갈등을 싫어합니다.',
      koreanTraits:
        '한국의 중용과 조화를 중시하는 문화와 잘 맞으며, 외교나 중재 능력이 뛰어납니다.',
    },
    career: {
      suitable: [
        '변호사',
    ...
    love: {
      style:
        '로맨틱하고 균형잡힌 관계를 추구하며, 상대방과의 조화를 중시합니다.',
      preference:
        '세련되고 교양있는 상대를 선호하며, 외모도 중요하게 생각합니다.',
      koreanDating:
        '분위기 있는 레스토랑이나 전시회 데이트를 좋아하고, 커플룩이나 커플템을 즐깁니다.',
      compatibility: {
        best: ['쌍둥이자리', '물병자리'],
        good: ['양자리', '사자자리'],
        challenging: ['게자리', '염소자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국의 한방 치료나 아로마 테라피 등 자연 치유법에 관심이 많습니다.',
    },
    money: {
      tendency:
        '균형잡힌 소비를 하려 노력하지만 미적인 것에는 돈을 많이 씁니다.',
      investment: '안전하고 미적 가치가 있는 투자를 선호합니다.',
      koreanMoney:
        '한국에서는 예술품이나 명품, 인테리어에 투자하는 경향이 있습니다.',
    },
  },
  ...
  scorpio: {
    ...
    personality: {
      ...
      traits:
        '강렬하고 신비로우며, 뛰어난 통찰력으로 사물의 본질을 꿰뚫어 봅니다. 모든 일에 열정적으로 몰입합니다.',
      koreanTraits:
        '한국 드라마의 강렬한 멜로나 복수 스토리를 좋아하며, 깊이 있는 관계를 추구합니다.',
    },
    career: {
      suitable: [
        '심리학자',
    ...
    love: {
      style:
        '강렬하고 깊은 사랑을 추구하며, 상대방과 완전히 하나가 되기를 원합니다.',
      preference:
        '진실하고 깊이 있는 상대를 선호하며, 피상적인 관계를 싫어합니다.',
      koreanDating:
        '한 사람과 깊고 진지한 관계를 원하며, 바람기나 불륜을 절대 용납하지 않습니다.',
      compatibility: {
        best: ['게자리', '물고기자리'],
        good: ['처녀자리', '염소자리'],
        challenging: ['사자자리', '물병자리'],
    ...
    health: {
      ...
      koreanHealth:
        '한국의 찜질방이나 사우나 등 디톡스 문화를 좋아하고 건강에 도움이 됩니다.',
    },
    money: {
      tendency: '돈에 대한 집착이 강하며, 투자나 재테크에 깊이 파고듭니다.',
      investment:
        '위험을 감수하더라도 큰 수익을 추구하며, 부동산이나 주식에 집중 투자합니다.',
      koreanMoney:
        '한국에서는 부동산이나 주식의 숨겨진 가치를 찾아내는 능력이 뛰어납니다.',
    },
  },
  ...
  sagittarius: {
    ...
    personality: {
      ...
      traits:
        '자유를 사랑하고 새로운 경험을 추구합니다. 낙관적이고 철학적이며, 진리를 탐구하는 것을 좋아합니다.',
      koreanTraits:
        '한국에서 해외 여행이나 워홀, 유학 등을 가장 많이 가는 별자리입니다. 글로벌한 감각이 뛰어납니다.',
    },
    career: {
      suitable: [
        '여행가이드',
      ...
      advice:
        '계획성과 책임감을 기르고, 한 가지 일에 집중하는 능력을 개발하세요.',
    },
    love: {
      style:
        '자유롭고 개방적인 연애를 추구하며, 모험과 새로운 경험을 함께 할 상대를 원합니다.',
      preference:
        '지적이고 유머가 있으며, 자유로운 사고를 가진 상대를 선호합니다.',
      koreanDating:
        '여행이나 페스티벌 등 새로운 경험을 함께 하는 데이트를 좋아합니다.',
      compatibility: {
        best: ['양자리', '사자자리'],
        good: ['천칭자리', '물병자리'],
        challenging: ['처녀자리', '물고기자리'],
    ...
    health: {
      ...
      advice:
        '과도한 활동으로 인한 부상을 주의하고, 규칙적인 생활을 유지하세요.',
      koreanHealth:
        '한국의 산행이나 트레킹 등 야외 활동을 통해 건강을 유지합니다.',
    },
    money: {
      tendency:
        '돈을 여행이나 경험에 많이 쓰며, 미래를 위한 저축보다는 현재를 즐깁니다.',
      investment: '해외 투자나 새로운 분야의 투자에 관심이 많습니다.',
      koreanMoney:
        '한국에서는 해외 펀드나 해외 부동산, 암호화폐 등에 투자하는 경향이 있습니다.',
    },
  },
  ...
  capricorn: {
    ...
    personality: {
      ...
      traits:
        '목표 지향적이고 책임감이 강하며, 꾸준한 노력으로 성공을 이룹니다. 전통과 질서를 중시합니다.',
      koreanTraits:
        '한국의 수직적 조직 문화에 잘 적응하며, 대기업이나 공공기관에서 성공하는 경우가 많습니다.',
    },
    career: {
      suitable: [
        'CEO',
      ...
      strengths:
        '체계적이고 계획적인 업무 수행 능력이 뛰어나며, 장기적인 목표를 달성하는 데 탁월합니다.',
      advice: '융통성을 기르고, 부하직원들과의 소통을 늘리세요.',
    },
    love: {
      style:
        '신중하고 진지한 연애를 하며, 결혼을 전제로 한 안정적인 관계를 추구합니다.',
      preference: '사회적 지위가 있고 경제적으로 안정된 상대를 선호합니다.',
      koreanDating:
        '혼인신고부터 아이 계획까지 체계적으로 계획하며, 양가 부모님의 만남을 중요시합니다.',
      compatibility: {
        best: ['황소자리', '처녀자리'],
        good: ['게자리', '전갈자리'],
        challenging: ['양자리', '천칭자리'],
  ...
  aquarius: {
    ...
    personality: {
      ...
      traits:
        '독창적이고 미래지향적이며, 인류를 위한 큰 그림을 그리는 것을 좋아합니다. 자유롭고 독립적인 성격입니다.',
      koreanTraits:
        '한국의 IT 기술 발전과 혁신 문화를 이끄는 별자리입니다. 새로운 트렌드를 만들어내는 능력이 뛰어납니다.',
    },
    career: {
      suitable: [
        'IT 개발자',
      ...
      strengths:
        '혁신적인 아이디어와 미래를 내다보는 안목으로 새로운 분야를 개척합니다.',
      advice: '현실성을 고려하고, 팀워크를 중시하는 자세가 필요합니다.',
    },
    love: {
      style: '자유롭고 독립적인 관계를 추구하며, 정신적 교감을 중시합니다.',
      preference:
        '독특하고 개성있는 상대를 선호하며, 서로의 자유를 존중하는 관계를 원합니다.',
      koreanDating:
        '온라인에서 만나거나 취미 모임을 통한 만남을 선호하고, 전통적인 데이트보다는 새로운 경험을 추구합니다.',
      compatibility: {
        best: ['쌍둥이자리', '천칭자리'],
        good: ['양자리', '사수자리'],
        challenging: ['황소자리', '전갈자리'],
    ...
    health: {
      ...
      advice:
        '새로운 건강법에만 의존하지 말고 기본적인 건강 관리도 중요합니다.',
      koreanHealth:
        '한국의 첨단 의료 기술이나 웰니스 트렌드를 빠르게 받아들입니다.',
    },
    money: {
      tendency: '미래 기술이나 혁신적인 분야에 투자하는 것을 좋아합니다.',
      investment:
        '암호화폐, AI 관련 주식, 친환경 에너지 등 미래 산업에 투자합니다.',
      koreanMoney:
        '한국에서는 코인이나 IT 기술주, ESG 투자 등에 관심이 많습니다.',
    },
  },
  ...
  pisces: {
    ...
    personality: {
      ...
      traits:
        '감수성이 풍부하고 직관력이 뛰어나며, 예술적 재능이 있습니다. 타인의 감정을 잘 이해하고 동정심이 많습니다.',
      koreanTraits:
        '한국의 감성적이고 정서적인 문화와 잘 맞으며, 예술이나 힐링 분야에서 재능을 발휘합니다.',
    },
    career: {
      suitable: [
        '예술가',
      ...
      strengths:
        '타인을 치유하고 영감을 주는 능력이 뛰어나며, 창의적인 작업에서 최고의 성과를 냅니다.',
      advice: '현실적인 계획 수립과 실행력을 기르는 것이 중요합니다.',
    },
    love: {
      style:
        '로맨틱하고 헌신적인 사랑을 추구하며, 상대방과 하나가 되고 싶어합니다.',
      preference:
        '감성적이고 이해심 많은 상대를 선호하며, 정신적 교감을 중시합니다.',
      koreanDating:
        '감성적인 K-드라마 같은 로맨스를 꿈꾸며, 기념일이나 특별한 순간을 소중히 여깁니다.',
      compatibility: {
        best: ['게자리', '전갈자리'],
        good: ['황소자리', '염소자리'],
        challenging: ['쌍둥이자리', '사수자리'],
...
const generateZodiacFortune = function (zodiacSign, period = 'daily') {
  ...
  return {
    ...
    lucky: {
      ...
      number:
        zodiac.lucky.numbers[Math.abs(seed) % zodiac.lucky.numbers.length],
...
const getLuckyItem = function (zodiacSign, seed) {
  ...
  const elementType =
    expandedZodiacData[zodiacSign].element === '불'
      ? 'fire'
      : expandedZodiacData[zodiacSign].element === '흙'
        ? 'earth'
        : expandedZodiacData[zodiacSign].element === '바람'
          ? 'air'
          : 'water';
