...
const tetoEgenQuestions = [
  ...
  },
  {
    ...
    options: [
      {
        text: '제가 팀장 할게요! 전체적으로 관리하면서 진행할게요',
        score: 3,
        type: 'teto',
      },
      {
        text: '발표는 제가 할게요, 사람들 앞에서 말하는 거 좋아해요',
        score: 2,
        type: 'teto',
      },
      {
        text: '각자 잘하는 걸로 나눠서 하면 될 것 같아요',
        score: 0,
        type: 'balanced',
      },
      {
        text: '자료 조사나 분석 쪽이 제 스타일이에요',
        score: -2,
        type: 'egen',
      },
  ...
  },
  {
    ...
    options: [
      {
        text: '직접 만나서 술 한잔하면서 속 시원히 들어줄게!',
        score: 3,
        type: 'teto',
      },
      { text: '구체적인 해결책을 제시하면서 조언해줌', score: 2, type: 'teto' },
      {
        text: '충분히 들어주고 공감하면서 위로해줌',
        score: 0,
        type: 'balanced',
      },
      {
        text: '조용히 들어주고 필요할 때만 의견 제시',
        score: -2,
        type: 'egen',
      },
  ...
  },
  {
    ...
    options: [
      {
        text: '뮤비 보고 바로 플레이리스트 추가, SNS 팔로우!',
        score: 3,
        type: 'teto',
      },
